  ...
  <div class="parsenc">
    <div class="parsenc-head">
      <el-row :gutter="20">
        ...
        <el-col :span="3">
          <label for="avatar" aria-label="right">请选择需要解析的nc文件:</label>
        </el-col>
        <el-col :span="3">
          <el-input type='file' v-model="filePath"/>{{filePath}}
        </el-col>
        <el-col :span="4">
          <el-button type="primary" :icon="Search" @click="ParseNC">开始解析</el-button>
...
//导入receive.js文件
import {parseNC} from "@/api/sys/parsenc.js";
...
const getNCList = async () => {
  ...
  const result = await parseNC(params);
