<template>
    <div class="receive">
      <div class="receive-head">
        <el-row :gutter="20">
          <el-col :span="4">
            <el-button type="primary" :icon="Star">取消收藏</el-button>
          </el-col>
          <el-col :span="5">
            <el-date-picker
              v-model="time"
  ...
  import { Star, Search, Share } from '@element-plus/icons-vue'
  import moment from 'moment'
//导入receive.js文件
import { listFavorite, HandleDelete, handleFavorite } from '@/api/sys/receive.js'
...
const getFavoriteList = async () => {
  ...
  const result = await listFavorite(params);
